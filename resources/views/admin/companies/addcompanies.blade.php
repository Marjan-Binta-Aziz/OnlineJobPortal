              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="company_name" id="company_name" placeholder="Input Name">      
                </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="email" class="form-control" name="company_email" id="company_email" placeholder="Input Email">      
                </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="company_phoneNo" id="company_phoneNo" placeholder="Input Phone No">      
                </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="company_adderss" id="company_adderss" placeholder="Input Location">      
                </div>
                </div>
                <section> <br>
                <label for="company_status">Company Status</label><br>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="company_status" id="company_status" value="Active" checked>
