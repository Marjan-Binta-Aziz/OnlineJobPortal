        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">edit_blog</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="col-md-12">
            ...
            <label for="blog_photo" class="form-label">Blog Photo</label>
                <div class="custom-file">
                    <input type="file" class="custom-file-input" id="blog_photo" name="blog_photo" value="{{$blog->blog_photo}}">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" name="blog_description" id="blog_description"  value="{{$blog->blog_description}}"></textarea>
                </div>
                </div>
                <section> <br>
